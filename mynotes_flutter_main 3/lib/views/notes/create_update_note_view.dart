...
//import 'package:flutter_application_1/services/cloud_list/firebase_cloud_storage.dart';
...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  Future<CloudNote> createOrGetExistingNote(BuildContext context) async {
    ...
    if (widgetNote != null) {
      ...
      print("Break");// NEED TO REMOVE LATER, BUT USE THIS VARIABLE FOR TELEPHONE URL 
