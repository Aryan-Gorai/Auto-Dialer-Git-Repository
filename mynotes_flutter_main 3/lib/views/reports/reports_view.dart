export 'reports_view_clean.dart';
final _ignoreReportsMangled = r'''
...
class ReportsView extends StatefulWidget {
  ...
  // Removed completion graph-related state and data fetching methods
  ...
  Widget build(BuildContext context) {
      ...
      // Removed completion graph-related state and methods
                        Row(
                          children: [
                            Text(
                              "Time Scale:",
